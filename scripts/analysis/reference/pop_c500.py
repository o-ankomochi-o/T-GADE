...
ARMS = {"EoH": "main_eoh_800_evt30_s2e2", "L": "x1_level_T0.00001_800_bh_sigE_s2e2", "N": "x1_none_T0.003_800_bh_sigE_s2e2"}
...
CACHE_PATH = os.path.join(ROOT, "pop_endpoint_cache_20260908.json")  # disk cache: reruns are free
...
for arm, pre in ARMS.items():
    for d in sorted(glob.glob(os.path.join(ROOT, f"eoh_{pre}_cs205*_2026*"))):
...
json.dump(table, open(os.path.join(ROOT, "pop_c500_table_20260908.json"), "w", encoding="utf-8"), indent=1)
