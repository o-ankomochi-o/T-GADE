...
CACHE_PATH = os.path.join(ROOT, "pop_endpoint_cache_R_20260908.json")  # disk cache: reruns are free
...
json.dump(table, open(os.path.join(ROOT, "pop_c500_table_R_20260909.json"), "w", encoding="utf-8"), indent=1)
