...
CACHE_PATH = os.path.join(ROOT, "pop_endpoint_cache_G1_20260909.json")
...
for arm, pre in ARMS.items():
    for d in sorted(glob.glob(os.path.join(ROOT, f"{pre}_cs206*_2026*"))):
...
json.dump(table, open(os.path.join(ROOT, "pop_c500_table_G1_20260909.json"), "w", encoding="utf-8"), indent=1)
